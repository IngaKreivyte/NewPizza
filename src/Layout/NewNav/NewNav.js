    ...
    render(props) {
        ...
        return (
            ...
            <div className={style.bagNav}>
                <div className={style.bagNavblockActive} >
                    <div className={style.bagNavElement} >1</div>
                    <span>Krepšelis</span>
                </div>
               <div className= { this.props.checkOut.adresspickUp||this.props.checkOut.adrress? style.bagNavblockActive:style.bagNavblock}>
